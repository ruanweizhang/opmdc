 ...
 */
package org.opendaylight.opmdc.cli.commands;
...
public class OpmdcCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(OpmdcCliTestCommand.class);
    protected final OpmdcCliCommands service;

    public OpmdcCliTestCommand(final OpmdcCliCommands service) {
