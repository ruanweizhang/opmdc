...
public final class GenericTransactionUtils {
    ...
    public static <T extends DataObject> boolean writeData(DataBroker dataBroker, LogicalDatastoreType logicalDatastoreType, 
        ...
        if (isAdd) {
            ...
            //modification.merge(logicalDatastoreType, iid, dataObject, true /*createMissingParents*/);   // not overwrite pre-exist state
            modification.put(logicalDatastoreType, iid, dataObject, true /*createMissingParents*/);  //overwrite pre-exist state
